...
public class UPythonLibrary : ModuleRules
{
	public UPythonLibrary(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			PublicAdditionalLibraries.Add(Path.Combine(ModuleDirectory, "Win64", "libs", "python39.lib"));
			...
			RuntimeDependencies.Add("$(PluginDir)/Binaries/ThirdParty/UPythonLibrary/Win64/python39.dll");
        }
