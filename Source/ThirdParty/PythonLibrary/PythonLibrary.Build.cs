...
public class PythonLibrary : ModuleRules
{
	public PythonLibrary(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
            ...
            PublicAdditionalLibraries.Add(Path.Combine(ModuleDirectory, "Win64", "lib", "PythonLibrary.lib"));
            ...
            RuntimeDependencies.Add("$(PluginDir)/Binaries/ThirdParty/PythonScriptLibrary/Win64/PythonLibrary.dll");
